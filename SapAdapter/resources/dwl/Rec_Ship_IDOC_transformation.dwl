...
---
{
	(p('inbound.recommendedShipments.idocType')) : {
		(using (supplyPlant = payload.plannedSupplyId.shipFrom.primaryId default "",
                    material = payload.plannedSupplyId.item.primaryId default "",
                    plant = payload.plannedSupplyId.shipTo.primaryId default "",
                    plantkey = payload.plannedSupplyId.shipTo.primaryId ++ '-' ++ payload.plannedSupplyId.shipFrom.primaryId,
