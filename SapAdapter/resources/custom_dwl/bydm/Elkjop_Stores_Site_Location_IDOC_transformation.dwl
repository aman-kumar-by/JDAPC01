...
(payload.*IDOC default [] map {
			...
			avpList : [
				{
					name : "STORE_SIZE",
					value : if (not (isEmpty($.E1KNA1M.Z1ZAKNA1.ZZ_STORE_SIZE))) $.E1KNA1M.Z1ZAKNA1.ZZ_STORE_SIZE else "NO-MAPPING-AVAILABLE"
				}
			...
			parentParty : {
				...
				//ELKJOP Mapping for primaryId
				primaryId : if (($.E1KNA1M.E1KNVVM.VKORG != "") and ($.E1KNA1M.E1KNVVM.VKORG != null)) $.E1KNA1M.E1KNVVM.VKORG else "UNKNOWN",
				parentRole : "CUSTOMER"
			},
			basicLocation : {
				...
				status : [{
					...
					//Elkjop Fields
					(effectiveFromDate : globalDataweaveFunctions::formatDate($.E1KNB5M.MADAT default "")) if (not (isEmpty(globalDataweaveFunctions::formatDate($.E1KNB5M.MADAT default "")))),
					(effectiveUpToDate : globalDataweaveFunctions::formatDate($.E1KNB5M.GMVDT default "")) if (not (isEmpty(globalDataweaveFunctions::formatDate($.E1KNB5M.GMVDT default ""))))
				}]
			},
			//ELKJOP Mapping for retailDetails
			retailDetails : {
				storeFormat: $.E1KNA1M.Z1ZAKNA1.ZZ_FORMAT_TYPE
			}
	})